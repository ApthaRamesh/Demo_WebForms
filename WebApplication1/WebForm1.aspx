<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master"
    AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebApplication1.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <asp:TextBox ID="txtName" runat="server"
        MaxLength="50" CssClass="myInput"></asp:TextBox>
    <hr />
    <asp:Button ID="ClickMe" runat="server" Text="Click Me" CssClass="myInput" 
